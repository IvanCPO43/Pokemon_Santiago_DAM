...
{
    public static Dictionary<(PokemonType, PokemonType), double> efectivos = new Dictionary<(PokemonType, PokemonType), double>
    {
        ...
        {(PokemonType.Poison, PokemonType.Fire), 0.5},
        ...
        {(PokemonType.Rock, PokemonType.Water), 0.5},
